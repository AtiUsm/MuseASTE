...
def app():
    ...
    x = st.sidebar.feedback("thumbs", key='objf')
    if x == 1:
        st.balloons()

    st.sidebar.pills("Tags", ["ASTE", "Knowledge Graph", "Aspect Sentiment Triplet Extraction","Aspect Based Knowledge Graphs"], key='objp')
    ...
    with tab1:
        ...
        st.selectbox('Choose a car id', options=['Sample'], index=0, key='sample_select')
