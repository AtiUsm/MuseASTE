...
if args.do_train:
    ...
    OPTIMIZER = AdamW(MODEL.parameters(), lr=3e-4, eps=1e-8, weight_decay=0.0)
    ...
    for epoch in range(args.num_train_epochs):
        ...
        #ODEL.log("train_loss", train_loss, prog_bar= True, logger= True)
            train_batch_count += 1
        ...
        for batch in tqdm(val_loader, desc="Validation batches"):
            ...
            #DEL.log("train_loss", val_loss, prog_bar= True, logger= True)
            val_batch_count += 1

        print(f"{epoch+1}/{2} -> Train loss: {train_loss / train_batch_count}\tValidation loss: {val_loss/val_batch_count}")
    MODEL.save_pretrained("laptop14_model")
    TOKENIZER.save_pretrained("laptop14_tokenizer")
...
if args.do_direct_eval:
    ...
    TOKENIZER = T5Tokenizer.from_pretrained("laptop14_tokenizer")
    MODEL = T5ForConditionalGeneration.from_pretrained("laptop14_model")
    ...
    exp_results = f"Raw F1 = {raw_scores[0]['triple']['f1']:.4f}}"
    log_str = f'============================================================\n'
