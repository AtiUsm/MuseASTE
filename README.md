...
4.	The main gold dataset and gold annoations in in the dataset folder. Th processed dataset for comparison with baselines is in the processed dataset folder.
