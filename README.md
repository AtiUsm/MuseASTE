...
2.	The text transcripts are already added after seeking permission from MuSe. Go to the primary dataset MuseCar-2020 [2,3] ([MuSeTopic 2020 - ACM MM 2020 (google.com)](https://sites.google.com/view/muse2020/challenge/get-data?authuser=0), and acquire the Muse-Topic dataset to get access to other labels that maybe of interest to you like topic/ aspect category in case you want to do ACC (Aspect Category Classification).
...
4.	Please manditorily cite our paper[10] (provided under Research Citation), and also cite the Muse-Dataset[2] and challenge[4].
