...
def app():
    ...
    try:
        ...
        if car_id==302:
            st.image('303.jpg', use_container_width=True)
        else:
    ...
    st.sidebar.title('Vehicle Specifications Panel')
    x = st.sidebar.feedback("thumbs", key='_objf')
    if x == 1:
        st.balloons()

    st.sidebar.pills("Tags", ["ASTE", "Knowledge Graph", "Aspect Sentiment Triplet Extraction","Aspect Based Knowledge Graphs"], key='_objp')
    ...
    with tab1:
        ...
        images = [
            ("images/car.jpeg", "Car"),
            ("images/steering.jpeg", "Steering Wheel"),
            ("images/boot.jpg", "Boot"),
            ("images/seats.jpeg", "Seats"),
            ("images/glovebox.jpeg", "Glove Box"),
            ("images/satnav.jpeg", "Satellite Navigation"),
            ("images/gear.jpg", "Gear")
        ]
        ...
        st.markdown(
            ...
            <br><br><br>⚠️ Note: The images  used are automatically crawled from the internet for the sake of demo for non-commercial research purposes. <br>⚠️ Verify copyright if publishing!</b>.<br>
            <br><b>Dataset images cannot be published publicly. To get authorized access to the dataset, please sign the End User License Agreement at 
            <a href='https://sites.google.com/view/muse2020/challenge/get-data?authuser=0' target='MuseCar Dataset'>this link</a>.</b>
            </div>
            """,
            unsafe_allow_html=True
        )
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/hw8wtDVYtaA" 
       ...
       """, unsafe_allow_html=True)
        ...
        """
        <div style="margin-top: 40px; font-size:14px; color: gray;">
        <br><br><br>⚠️ Note: The video used is a sample from the internet for the sake of demo for non-commercial research purposes. <br>⚠️ Verify copyright if publishing!</b>.<br>
        <br><b>Dataset videos cannot be published publicly. To get authorized access to the dataset, please sign the End User License Agreement at 
        <a href='https://sites.google.com/view/muse2020/challenge/get-data?authuser=0' target='MuseCar Dataset'>this link</a> The copyright.csv file contains the list of Youtube video links.</b>
        </div>
        """,
        unsafe_allow_html=True
    )
